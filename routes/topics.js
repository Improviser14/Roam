...
router.get("/", function(req, res){
    ...
    console.log("EFM: About to query the database");
    
    
    //get all topics from DB
    Topic.find({}).skip((perPage * pageNumber) - perPage).limit(perPage).exec(function(err, allTopics){
        if(err){
            console.log(err);
        }
        var count = allTopics.length;
    ...
    console.log("EFM: Done querying database");
});
